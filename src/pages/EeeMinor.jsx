    ...
    <div className="min-h-screen flex flex-col bg-indigo-50">
      ...
      <div className="relative w-full h-72 flex items-center justify-center text-center overflow-hidden mb-8">
        ...
        <div className="relative z-10 text-white px-6">
          <h1 className="text-5xl font-extrabold mb-2 drop-shadow-lg">EEE Mini Projects</h1>
          <p className="text-lg text-gray-200 max-w-2xl mx-auto">Explore a curated list of Electrical & Electronics Mini Projects for students and professionals.</p>
        </div>
      </div>
      <div className="flex-1 flex flex-col items-center justify-center py-16">
        <h1 className="text-4xl font-bold text-indigo-800 mb-4">EEE Mini Projects</h1>
        <p className="text-lg text-gray-700 mb-8">List of Electrical & Electronics Mini Projects will appear here.</p>
