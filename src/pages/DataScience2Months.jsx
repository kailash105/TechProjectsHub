    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-100 via-purple-50 to-white relative overflow-x-hidden">
      ...
      <div className="relative w-full flex flex-col items-center justify-center pt-16 pb-8">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 drop-shadow mb-4 text-center">Data Science - 2 Months</h1>
          ...
          <p className="max-w-2xl text-lg text-gray-700 mb-6 text-center font-medium">
            Perfect for those who want a deeper dive into data science, including visualization, ML basics, and a more substantial project experience.
          </p>
        </div>
        ...
        <div className="backdrop-blur-lg bg-white/70 border border-blue-200 rounded-3xl shadow-2xl p-8 mb-10">
          ...
          <ol className="relative border-l-4 border-blue-300 ml-4">
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-blue-800">Python for data science, data analysis, visualization</h3>
            ...
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-purple-800">ML basics, model evaluation</h3>
            ...
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-yellow-800">Project work</h3>
              <p className="text-gray-600">Weeks 5-6: Building a data science application</p>
            </li>
            <li className="ml-6">
              ...
              <h3 className="font-semibold text-lg text-pink-800">Advanced visualization and ML techniques</h3>
