  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="max-w-3xl mx-auto w-full px-4 py-12 flex-1">
        <h1 className="text-4xl font-extrabold text-green-700 mb-6 text-center">Data Science Training - 1 Month</h1>
        <div className="bg-green-50 rounded-3xl shadow-xl p-8 mb-8">
          ...
          <p className="text-gray-700 mb-4">Ideal for beginners or those looking for a fast-track introduction to data science. This intensive 1-month program covers the essentials to get you started with Python for data science and data analysis basics.</p>
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
            ...
            <li>Week 2: Data analysis basics</li>
            <li>Week 3: Visualization basics</li>
            <li>Week 4: Mini project (basic data analysis)</li>
          </ul>
