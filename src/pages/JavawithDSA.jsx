...
function JavawithDSA() {
  ...
  const toolsCovered = [
    { category: "Programming", tools: ["Java 8+", "Eclipse", "IntelliJ IDEA", "VS Code"] },
    { category: "Data Structures", tools: ["Arrays", "Collections", "Trees", "Graphs", "Heaps"] },
    ...
    { category: "Frameworks", tools: ["Spring Boot", "JUnit", "Maven", "Gradle"] }
  ];

  const whyChooseUs = [
    { icon: Target, title: "Interview-Focused Training", desc: "Learn exactly what top tech companies ask" },
    { icon: Wrench, title: "Modern Java Tools", desc: "Use industry-standard Java development tools" },
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-yellow-50 via-green-50 to-white relative overflow-x-hidden">
      ...
      <div className="relative w-full flex flex-col items-center justify-center pt-20 pb-12">
        <img src={javaDSAImg} alt="Java with DSA" className="absolute top-0 right-0 w-48 opacity-20 pointer-events-none select-none hidden md:block" style={{zIndex:1}} />
        <div className="relative z-10 flex flex-col items-center">
          <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-600 to-green-600 drop-shadow mb-4 text-center">Java with DSA Training Program</h1>
          <span className="inline-block bg-yellow-100 text-yellow-800 px-4 py-1 rounded-full text-sm font-semibold mb-4 shadow">Comprehensive Data Structures & Algorithms Training</span>
          <p className="max-w-3xl text-lg text-gray-700 mb-6 text-center font-medium">
            Master Java programming and Data Structures & Algorithms for coding interviews. 
            Choose your training duration and build a strong foundation for technical interviews and problem solving.
          </p>
        </div>
        <img src={javaDSAImg} alt="Java with DSA" className="w-32 h-32 rounded-full shadow-lg border-4 border-white bg-white object-contain mt-4 mb-2 z-20" />
      </div>
      ...
      <div className="max-w-6xl mx-auto w-full px-4 mb-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white/80 backdrop-blur-lg border border-yellow-200 rounded-2xl p-6 shadow-lg">
            ...
            <p className="text-gray-600 text-sm">Java programming and DSA problem-solving tools</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-lg border border-purple-200 rounded-2xl p-6 shadow-lg">
            ...
            <p className="text-gray-600 text-sm">A hands-on training platform for tech learners in Java, DSA, and more</p>
          </div>
      ...
      <div className="max-w-4xl mx-auto w-full px-4 mb-12">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Complete Java DSA training with advanced problem-solving skills</p>
        </div>
      </div>

      {/* Course Content Display */}
      <div className="backdrop-blur-lg bg-white/70 border border-yellow-200 rounded-3xl shadow-2xl p-8">
        <h3 className="text-2xl font-bold text-yellow-700 mb-4 text-center">{courseData.title}</h3>
      ...
      <div className="max-w-6xl mx-auto w-full px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-2">40% Discount on Industry-Ready Java DSA Training</p>
          <p className="text-lg text-gray-500">No hidden charges, just real value crafted for future problem solvers</p>
        </div>

        <div className="max-w-2xl mx-auto">
          {/* 3-Month Plan */}
          <div className="bg-white rounded-2xl shadow-xl border-2 border-yellow-200 p-8 relative overflow-hidden transform scale-105">
            ...
            <div className="absolute top-4 left-4 bg-yellow-500 text-white px-3 py-1 text-xs font-bold rounded-full">
              COMPREHENSIVE
            </div>
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-gray-800 mb-2">3-Month Java DSA Professional</h3>
              <p className="text-gray-600 mb-4">Complete comprehensive training</p>
              <div className="mb-4">
                <span className="text-3xl font-bold text-yellow-600">₹14,000</span>
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-2">
                ...
                <span className="text-gray-700">Complete Java DSA training</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-yellow-500" />
      ...
      <div className="max-w-6xl mx-auto w-full px-4 mb-12">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Master Java programming and DSA problem-solving tools</p>
        </div>
      ...
      <div className="max-w-4xl mx-auto w-full px-4 mb-12">
        <div className="bg-white/80 backdrop-blur-lg border border-purple-200 rounded-3xl shadow-2xl p-8">
          ...
          <p className="text-gray-700 text-center text-lg mb-8">
            A hands-on training platform for tech learners in Java Development, DSA, and more.
          </p>
