    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-100 via-blue-50 to-white relative overflow-x-hidden">
      ...
      <div className="relative w-full flex flex-col items-center justify-center pt-16 pb-8">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600 drop-shadow mb-4 text-center">Block Chain Training - 2 Months</h1>
          ...
          <p className="max-w-2xl text-lg text-gray-700 mb-6 text-center font-medium">
            Perfect for those who want a deeper dive into blockchain, including smart contracts, cryptocurrencies, and a more substantial project experience.
          </p>
        </div>
        ...
        <div className="backdrop-blur-lg bg-white/70 border border-green-200 rounded-3xl shadow-2xl p-8 mb-10">
          ...
          <ol className="relative border-l-4 border-green-300 ml-4">
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-green-800">Blockchain fundamentals, distributed ledgers</h3>
            ...
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-yellow-800">Blockchain platforms, security basics</h3>
            ...
            <li className="ml-6">
              ...
              <h3 className="font-semibold text-lg text-pink-800">Project work (building a blockchain application)</h3>
