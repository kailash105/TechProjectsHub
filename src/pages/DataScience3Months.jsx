    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-100 via-purple-50 to-white relative overflow-x-hidden">
      ...
      <div className="relative w-full flex flex-col items-center justify-center pt-16 pb-8">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 drop-shadow mb-4 text-center">Data Science - 3 Months</h1>
          ...
          <p className="max-w-2xl text-lg text-gray-700 mb-6 text-center font-medium">
            Best for those seeking a comprehensive, career-oriented program in data science, including full data science projects, deployment, and placement preparation.
          </p>
        </div>
        ...
        <div className="backdrop-blur-lg bg-white/70 border border-blue-200 rounded-3xl shadow-2xl p-8 mb-10">
          ...
          <ol className="relative border-l-4 border-blue-300 ml-4">
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-blue-800">Python, data analysis, visualization, ML basics</h3>
            ...
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-purple-800">Advanced ML, deployment, model evaluation</h3>
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
            <li>Build and deploy advanced data science projects</li>
...
export default DataScience3Months; 