  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="max-w-3xl mx-auto w-full px-4 py-12 flex-1">
        <h1 className="text-4xl font-extrabold text-green-700 mb-6 text-center">Back End Training - 2 Months</h1>
        <div className="bg-green-50 rounded-3xl shadow-xl p-8 mb-8">
          ...
          <p className="text-gray-700 mb-4">Perfect for those who want a deeper dive into back-end development, including REST APIs, authentication, and a more substantial project experience.</p>
          <h2 className="text-2xl font-bold text-green-800 mb-4 mt-8">Syllabus & Schedule</h2>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
            <li>Weeks 1-2: Server-side programming, database integration</li>
            <li>Weeks 3-4: REST API development, authentication</li>
            <li>Weeks 5-6: Security, performance optimization</li>
            <li>Weeks 7-8: Project work (building a back-end system)</li>
          </ul>
