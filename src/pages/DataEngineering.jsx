...
function DataEngineering() {
  ...
  const menu = [
    { label: "1 Month", path: "/training/data-engineering/1-month" },
    { label: "2 Months", path: "/training/data-engineering/2-months" },
    { label: "3 Months", path: "/training/data-engineering/3-months" },
  ];
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-100 via-blue-50 to-white relative overflow-x-hidden">
      ...
      <div className="relative w-full flex flex-col items-center justify-center pt-16 pb-8">
        <img src={dataEngImg} alt="Data Engineering" className="absolute top-0 right-0 w-48 opacity-20 pointer-events-none select-none hidden md:block" style={{zIndex:1}} />
        <div className="relative z-10 flex flex-col items-center">
          <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600 drop-shadow mb-4 text-center">Data Engineering Training</h1>
          ...
          <p className="max-w-2xl text-lg text-gray-700 mb-6 text-center font-medium">
            Master Data Engineering with hands-on projects, real-world data pipelines, and expert guidance. Choose your training duration below.
          </p>
        </div>
        <img src={dataEngImg} alt="Data Engineering" className="w-32 h-32 rounded-full shadow-lg border-4 border-white bg-white object-contain mt-4 mb-2 z-20" />
      </div>
      {/* Duration Menu */}
        ...
        <div className="backdrop-blur-lg bg-white/70 border border-green-200 rounded-3xl shadow-2xl p-8 mb-10">
          ...
          <ol className="relative border-l-4 border-green-300 ml-4">
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-green-800">ETL & Data Pipelines</h3>
              <p className="text-gray-600">ETL basics, data pipeline design, automation</p>
            </li>
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-blue-800">Big Data Tools</h3>
              <p className="text-gray-600">Hadoop, Spark, distributed processing</p>
            </li>
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-yellow-800">Cloud Data Platforms</h3>
              <p className="text-gray-600">AWS, Azure, GCP, cloud data warehousing</p>
            </li>
            <li className="mb-8 ml-6">
              ...
              <p className="text-gray-600">End-to-end pipeline, deployment, interview prep</p>
            </li>
          </ol>
        </div>
      </div>
