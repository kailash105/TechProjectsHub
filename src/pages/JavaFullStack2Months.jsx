  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="max-w-3xl mx-auto w-full px-4 py-12 flex-1">
        <h1 className="text-4xl font-extrabold text-green-700 mb-6 text-center">Java Full Stack Training - 2 Months</h1>
        <div className="bg-green-50 rounded-3xl shadow-xl p-8 mb-8">
          ...
          <p className="text-gray-700 mb-4">Perfect for those who want a deeper dive into Java full stack development, including front-end with React, back-end with Spring Boot, and a more substantial project experience.</p>
          <h2 className="text-2xl font-bold text-green-800 mb-4 mt-8">Syllabus & Schedule</h2>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
            <li>Weeks 1-2: HTML, CSS, JavaScript, Java programming</li>
            <li>Weeks 3-4: React basics, Spring Boot introduction</li>
