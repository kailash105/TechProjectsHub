  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="max-w-4xl mx-auto w-full px-4 py-12 flex-1">
        <h1 className="text-4xl font-extrabold text-green-700 mb-8 text-center">AI/ML Training</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="rounded-3xl border-2 border-green-400 bg-green-50 p-10 flex flex-col items-center shadow-2xl min-h-[400px]">
              ...
              <ul className="text-gray-700 text-base mb-6 list-disc list-inside">
                ...
                <li>Data preprocessing basics</li>
                <li>Mini project</li>
              </ul>
              ...
              <a href="/training/ai-ml/1-month" className="px-6 py-2 bg-white border border-green-600 text-green-700 rounded-xl font-semibold shadow hover:bg-green-100 transition text-base">Learn More</a>
            </div>
            {/* 2 Months Plan */}
            <div className="rounded-3xl border-2 border-green-400 bg-green-50 p-10 flex flex-col items-center shadow-2xl min-h-[400px]">
              ...
              <a href="/contact" className="px-8 py-3 bg-green-600 text-white rounded-xl font-bold shadow-lg hover:bg-green-700 transition text-lg mb-2">Enroll Now</a>
              <a href="/training/ai-ml/2-months" className="px-6 py-2 bg-white border border-green-600 text-green-700 rounded-xl font-semibold shadow hover:bg-green-100 transition text-base">Learn More</a>
            </div>
            {/* 3 Months Plan */}
            <div className="rounded-3xl border-2 border-green-400 bg-green-50 p-10 flex flex-col items-center shadow-2xl min-h-[400px]">
              ...
              <ul className="text-gray-700 text-base mb-6 list-disc list-inside">
                ...
                <li>Capstone AI/ML project</li>
                <li>Interview & placement prep</li>
              </ul>
              <div className="text-3xl font-extrabold text-green-700 mb-6">₹12,999</div>
              <a href="/contact" className="px-8 py-3 bg-green-600 text-white rounded-xl font-bold shadow-lg hover:bg-green-700 transition text-lg mb-2">Enroll Now</a>
              <a href="/training/ai-ml/3-months" className="px-6 py-2 bg-white border border-green-600 text-green-700 rounded-xl font-semibold shadow hover:bg-green-100 transition text-base">Learn More</a>
            </div>
          </div>
        </div>
