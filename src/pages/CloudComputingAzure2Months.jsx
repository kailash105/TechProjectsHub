    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-100 via-green-50 to-white relative overflow-x-hidden">
      ...
      <div className="relative w-full flex flex-col items-center justify-center pt-16 pb-8">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-600 drop-shadow mb-4 text-center">Cloud Computing (Azure) Training - 2 Months</h1>
          <span className="inline-block bg-blue-100 text-blue-800 px-4 py-1 rounded-full text-sm font-semibold mb-4 shadow">Deeper Dive</span>
          <p className="max-w-2xl text-lg text-gray-700 mb-6 text-center font-medium">
            Perfect for those who want a deeper dive into cloud computing with Azure, including advanced services, security, and a more substantial project experience.
          </p>
        </div>
        ...
        <div className="backdrop-blur-lg bg-white/70 border border-blue-200 rounded-3xl shadow-2xl p-8 mb-10">
          ...
          <ol className="relative border-l-4 border-blue-300 ml-4">
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-blue-800">Cloud fundamentals, Azure core services</h3>
            ...
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-green-800">Azure storage, networking, and databases</h3>
            ...
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-yellow-800">Security, monitoring, and automation</h3>
            ...
            <li className="ml-6">
              ...
              <h3 className="font-semibold text-lg text-pink-800">Project work (deploying and managing cloud apps)</h3>
          ...
          <div className="text-2xl font-bold text-blue-700 mb-4 text-center">Fee: ₹8,999</div>
        </div>
      </div>
      {/* Call to Action */}
