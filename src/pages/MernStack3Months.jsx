    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-100 via-teal-50 to-white relative overflow-x-hidden">
      ...
      <div className="relative w-full flex flex-col items-center justify-center pt-16 pb-8">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-teal-600 drop-shadow mb-4 text-center">MERN Stack - 3 Months</h1>
          ...
          <p className="max-w-2xl text-lg text-gray-700 mb-6 text-center font-medium">
            Best for those seeking a comprehensive, career-oriented program in MERN stack development, including advanced topics, deployment, and placement preparation.
          </p>
        </div>
        ...
        <div className="backdrop-blur-lg bg-white/70 border border-green-200 rounded-3xl shadow-2xl p-8 mb-10">
          ...
          <ol className="relative border-l-4 border-green-300 ml-4">
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-green-800">JavaScript, React, Node.js, Express, MongoDB</h3>
            ...
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-teal-800">Advanced database, REST APIs, authentication, cloud deployment</h3>
            ...
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-yellow-800">Capstone project, interview & placement prep, advanced deployment</h3>
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
            <li>Build and deploy a MERN stack web application (end-to-end)</li>
...
export default MernStack3Months; 