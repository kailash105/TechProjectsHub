  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="max-w-3xl mx-auto w-full px-4 py-12 flex-1">
        <h1 className="text-4xl font-extrabold text-green-700 mb-6 text-center">Block Chain Training - 1 Month</h1>
        <div className="bg-green-50 rounded-3xl shadow-xl p-8 mb-8">
          ...
          <p className="text-gray-700 mb-4">Ideal for beginners or those looking for a fast-track introduction to blockchain technology. This intensive 1-month program covers the essentials to get you started with blockchain fundamentals and distributed ledgers.</p>
          <h2 className="text-2xl font-bold text-green-800 mb-4 mt-8">Syllabus & Schedule</h2>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
            <li>Week 1: Blockchain fundamentals</li>
            <li>Week 2: Distributed ledger basics</li>
            <li>Week 3: Blockchain use cases</li>
            <li>Week 4: Mini project (simple blockchain application)</li>
          </ul>
