...
function CloudComputingAzure1Month() {
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-100 via-green-50 to-white relative overflow-x-hidden">
      ...
      <div className="relative w-full flex flex-col items-center justify-center pt-16 pb-8">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-600 drop-shadow mb-4 text-center">Cloud Computing (Azure) Training - 1 Month</h1>
          ...
          <p className="max-w-2xl text-lg text-gray-700 mb-6 text-center font-medium">
            Ideal for beginners or those looking for a fast-track introduction to cloud computing with Azure. Covers cloud fundamentals and Azure basics.
          </p>
        </div>
        ...
        <div className="backdrop-blur-lg bg-white/70 border border-blue-200 rounded-3xl shadow-2xl p-8 mb-10">
          ...
          <ol className="relative border-l-4 border-blue-300 ml-4">
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-blue-800">Cloud computing fundamentals</h3>
            ...
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-green-800">Azure core services</h3>
            ...
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-yellow-800">Cloud storage and networking basics</h3>
            ...
            <li className="ml-6">
              ...
              <p className="text-gray-600">Week 4: Deploying a simple app on Azure</p>
            </li>
          </ol>
          <h2 className="text-2xl font-bold text-blue-700 mb-4 mt-8 text-center">Outcomes</h2>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
            <li>Understand cloud computing workflow</li>
            <li>Deploy a basic app on Azure</li>
...
export default CloudComputingAzure1Month; 