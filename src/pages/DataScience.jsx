    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-100 via-purple-50 to-white relative overflow-x-hidden">
      ...
      <div className="relative w-full flex flex-col items-center justify-center pt-16 pb-8">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 drop-shadow mb-4 text-center">Data Science</h1>
          ...
          <p className="max-w-2xl text-lg text-gray-700 mb-6 text-center font-medium">
            Dive into the world of data! Learn Python, statistics, ML, and visualization with hands-on projects and real datasets.
          </p>
        </div>
        ...
        <div className="backdrop-blur-lg bg-white/70 border border-blue-200 rounded-3xl shadow-2xl p-8 mb-10">
          ...
          <ol className="relative border-l-4 border-blue-300 ml-4">
            <li className="mb-8 ml-6">
              ...
              <p className="text-gray-600">Python basics, data types, libraries</p>
            </li>
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-purple-800">Statistics & Analysis</h3>
              <p className="text-gray-600">Descriptive stats, inferential stats, data wrangling</p>
            </li>
            <li className="mb-8 ml-6">
              ...
              <h3 className="font-semibold text-lg text-yellow-800">Visualization</h3>
              <p className="text-gray-600">Matplotlib, Seaborn, dashboards</p>
            </li>
            <li className="mb-8 ml-6">
              <span className="absolute flex items-center justify-center w-8 h-8 bg-green-500 rounded-full -left-5 ring-4 ring-white text-white font-bold">4</span>
              <h3 className="font-semibold text-lg text-green-800">Machine Learning</h3>
              <p className="text-gray-600">Supervised/unsupervised, scikit-learn, projects</p>
            </li>
            <li className="ml-6">
