  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="max-w-3xl mx-auto w-full px-4 py-12 flex-1">
        <h1 className="text-4xl font-extrabold text-green-700 mb-6 text-center">Java Full Stack Training - 1 Month</h1>
        <div className="bg-green-50 rounded-3xl shadow-xl p-8 mb-8">
          ...
          <p className="text-gray-700 mb-4">Ideal for beginners or those looking for a fast-track introduction to Java full stack development. This intensive 1-month program covers the essentials to get you started with HTML, CSS, JavaScript basics, and Java programming essentials.</p>
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
            ...
            <li>Week 2: Java programming essentials</li>
