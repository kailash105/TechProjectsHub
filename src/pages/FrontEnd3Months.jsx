  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="max-w-3xl mx-auto w-full px-4 py-12 flex-1">
        <h1 className="text-4xl font-extrabold text-green-700 mb-6 text-center">Front End Training - 3 Months</h1>
        <div className="bg-green-50 rounded-3xl shadow-xl p-8 mb-8">
          ...
          <p className="text-gray-700 mb-4">Best for those seeking a comprehensive, career-oriented program in front-end development, including advanced topics, deployment, and placement preparation.</p>
          <h2 className="text-2xl font-bold text-green-800 mb-4 mt-8">Syllabus & Schedule</h2>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
            <li>Weeks 1-4: HTML, CSS, JavaScript, frameworks, UI/UX</li>
            <li>Weeks 5-8: State management, API integration, performance optimization</li>
