        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="font-bold text-xl text-white">TechProjectsHub</h3>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/techprojectshub?igsh=MXdwdHRyaHNnMnMw" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                 className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/" className="hover:text-blue-400 transition-colors flex items-center gap-2 group">
                <span className="w-1 h-1 bg-gray-400 rounded-full group-hover:bg-blue-400 transition-colors"></span>
                Home
              </Link></li>
              <li><Link to="/about" className="hover:text-blue-400 transition-colors flex items-center gap-2 group">
                <span className="w-1 h-1 bg-gray-400 rounded-full group-hover:bg-blue-400 transition-colors"></span>
                About
              </Link></li>
              <li><Link to="/services" className="hover:text-blue-400 transition-colors flex items-center gap-2 group">
                <span className="w-1 h-1 bg-gray-400 rounded-full group-hover:bg-blue-400 transition-colors"></span>
                Services
              </Link></li>
              <li><Link to="/training" className="hover:text-blue-400 transition-colors flex items-center gap-2 group">
                <span className="w-1 h-1 bg-gray-400 rounded-full group-hover:bg-blue-400 transition-colors"></span>
                Training
              </Link></li>
              <li><Link to="/contact" className="hover:text-blue-400 transition-colors flex items-center gap-2 group">
                <span className="w-1 h-1 bg-gray-400 rounded-full group-hover:bg-blue-400 transition-colors"></span>
                Contact
              </Link></li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/research" className="hover:text-blue-400 transition-colors flex items-center gap-2 group">
                <span className="w-1 h-1 bg-gray-400 rounded-full group-hover:bg-blue-400 transition-colors"></span>
                Research Papers
              </Link></li>
              <li><Link to="/custom-projects" className="hover:text-blue-400 transition-colors flex items-center gap-2 group">
                <span className="w-1 h-1 bg-gray-400 rounded-full group-hover:bg-blue-400 transition-colors"></span>
                Customized Projects
              </Link></li>
              <li><Link to="/training" className="hover:text-blue-400 transition-colors flex items-center gap-2 group">
